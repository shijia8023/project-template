<template>
    <sapi-dialog v-model="visible" width="500px" top="26%" class="add" @on-open="open" @on-close="close">
        <span slot="title" v-text="$t('supplierManage.addSupplierContactTitle')"></span>
        <div class="form-error-tips"></div>
        <div class="form-content">
            <div class="fullline">
                <span class="w-65 must-star" v-text="$t('supplierManage.contactName')"></span>
                <div class="right-auto-box">
                    <el-input id="txtContactName"  v-model.trim="createModel.ContactName" :maxlength="100"></el-input>
                </div>
            </div>
            ...
            <div class="fullline">
                ...
                <div class="right-auto-box">
                    <el-input id="txtPositionName"  v-model.trim="createModel.PositionName" :maxlength="50"></el-input>
                </div>
            </div>
    ...
    export default {
        ...
        methods: {
            ...
            submit() {
                ...
                this.$emit("call-back",[this.createModel,"contactAdd"]);
                this.close();
            },
            validate() {
                this.$closeWaringTips(".form-error-tips");
                if(!this.createModel.ContactName) {
